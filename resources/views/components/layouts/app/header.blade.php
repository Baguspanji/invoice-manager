...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    <flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navbar class="-mb-px max-lg:hidden">
            ...
            <flux:navbar.item icon="folder" :href="route('project.index')" :current="request()->routeIs('project.*')"
                wire:navigate>
                {{ __('Proyek') }}
            </flux:navbar.item>
            <flux:navbar.item icon="users" :href="route('client.index')" :current="request()->routeIs('client.*')"
                wire:navigate>
                {{ __('Klien') }}
            </flux:navbar.item>
            <flux:navbar.item icon="document-text" :href="route('invoice.index')" :current="request()->routeIs('invoice.*')"
                wire:navigate>
                {{ __('Invoice') }}
            </flux:navbar.item>
        </flux:navbar>
